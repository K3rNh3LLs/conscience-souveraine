...
const ACCENT_MAP = {
  ...
  // === BATCH 3: Remaining words found in part3 editorial review ===
  // More accent-missing words
  'precedentes': 'précédentes', 'precedent': 'précédent', 'precedente': 'précédente',
  'materialisent': 'matérialisent', 'materialise': 'matérialise',
  'interference': 'interférence', 'interferences': 'interférences',
  'interferer': 'interférer',
  'democratique': 'démocratique', 'democratiques': 'démocratiques',
  'stockee': 'stockée', 'stockees': 'stockées',
  'limitee': 'limitée', 'limitees': 'limitées',
  'bornee': 'bornée', 'bornees': 'bornées',
  'positionnes': 'positionnés', 'positionne': 'positionné', 'positionnee': 'positionnée',
  'definissent': 'définissent',
  'emetteur': 'émetteur', 'emetteurs': 'émetteurs',
  'photodetecteur': 'photodétecteur', 'photodetecteurs': 'photodétecteurs',
  'biometrique': 'biométrique', 'biometriques': 'biométriques',
  'resistante': 'résistante', 'resistant': 'résistant', 'resistants': 'résistants',
  'implementation': 'implémentation', 'implementations': 'implémentations',
  'implementer': 'implémenter',
  'alimentee': 'alimentée', 'alimente': 'alimenté',
  'gravees': 'gravées', 'gravee': 'gravée',
  'reservoir': 'réservoir', 'reservoirs': 'réservoirs',
  'reversibilite': 'réversibilité',
  'confirmee': 'confirmée', 'confirme': 'confirmé',
  'detail': 'détail', 'details': 'détails',
  'experimentalement': 'expérimentalement',
  'experimental': 'expérimental', 'experimentale': 'expérimentale', 'experimentaux': 'expérimentaux',
  'dephasage': 'déphasage',
  'encerclee': 'encerclée',
  'turbomoleculaires': 'turbomoléculaires',
  'arriere': 'arrière',
  'interiorisees': 'intériorisées', 'interiorise': 'intériorisé',
  'interiorisation': 'intériorisation',
  'reconnait': 'reconnaît',
  'decision': 'décision', 'decisions': 'décisions',
  'modelisation': 'modélisation',
  'developpementale': 'développementale',
  'micrometre': 'micromètre', 'micrometres': 'micromètres',
  'confinees': 'confinées', 'confinee': 'confinée',
  'resistent': 'résistent',
  'mammifere': 'mammifère', 'mammiferes': 'mammifères',
  'universite': 'université', 'universites': 'universités',
  'transfere': 'transfère',
  'refraction': 'réfraction',
  'structuree': 'structurée', 'structure': 'structuré',
  'defensif': 'défensif', 'defensive': 'défensive',
  'generalise': 'généralisé', 'generalisee': 'généralisée',
  'graphene': 'graphène',
  ...
  'createur': 'créateur', 'createurs': 'créateurs',
  'creature': 'créature', 'creatures': 'créatures',
  'concu': 'conçu', 'concue': 'conçue', 'concus': 'conçus',
  'parallelisme': 'parallélisme',
  'couplees': 'couplées', 'couplee': 'couplée',
  'reagir': 'réagir',
  'hierarchise': 'hiérarchisé',
  'recurrent': 'récurrent', 'recurrente': 'récurrente', 'recurrents': 'récurrents',
  'forcee': 'forcée',
  'debit': 'débit', 'debits': 'débits',
  'zero': 'zéro',
  'eprouve': 'éprouvé', 'eprouvee': 'éprouvée',
  'circonference': 'circonférence',
  'opposes': 'opposés', 'oppose': 'opposé', 'opposee': 'opposée',
  'praticite': 'praticité',
  'scelle': 'scellé', 'scellee': 'scellée',
  'adapte': 'adapté', 'adaptee': 'adaptée',
  'marine': null, // ambiguous (mariné vs marine)
  'termine': null, // ambiguous (terminé vs termine)
  'lance': null, // ambiguous (lancé vs lance)
  'avances': null, // ambiguous (avancés vs avances)
  'reserve': null, // ambiguous (réserve vs réservé)
  'phenomene': 'phénomène', 'phenomenes': 'phénomènes',
  'revele': 'révèle',
  'reveil': 'réveil',
  'necessaire': 'nécessaire', 'necessaires': 'nécessaires',
  ...
  'paliers': 'paliers', // no accent needed, correct as-is
  'mecaniques': 'mécaniques', 'mecanique': 'mécanique',
  'electro-optiques': 'électro-optiques',
  'nano-toroides': 'nano-toroïdes',
  'toroide': 'toroïde', 'toroides': 'toroïdes',
  'toroidale': 'toroïdale', 'toroidales': 'toroïdales',
  'integration': 'intégration',
  'integre': 'intégré', 'integres': 'intégrés', 'integree': 'intégrée',
  'deja': 'déjà',
  'theorique': 'théorique', 'theoriques': 'théoriques',
};
...
function fixAccents(text) {
  ...
  const aContextPatterns = [
    ...
    [/\bA partir\b/g, 'À partir'],
    [/\bA travers\b/g, 'À travers'],
    // "a" + number patterns (preposition before numbers)
    [/\ba 50\b/g, 'à 50'],
    [/\ba 2\b/g, 'à 2'],
    [/\ba 3\b/g, 'à 3'],
    [/\ba 10\b/g, 'à 10'],
    [/\ba 20\b/g, 'à 20'],
    [/\ba 100\b/g, 'à 100'],
    // "ou" → "où" in contextual patterns (relative pronoun)
    [/\bla ou\b/g, 'là où'],
    [/\bsystème ou chaque\b/g, 'système où chaque'],
    [/\bsysteme ou chaque\b/g, 'système où chaque'],
    [/\bou chaque\b/g, 'où chaque'],
    [/\bet ou la\b/g, 'et où la'],
    [/\bou le flux\b/g, 'où le flux'],
    [/\bou le cerveau\b/g, 'où le cerveau'],
    [/\bou l'intelligence\b/g, 'où l\'intelligence'],
    [/\bou l'énergie\b/g, 'où l\'énergie'],
    [/\bou il devient\b/g, 'où il devient'],
    [/\bou il\b/g, 'où il'],
    [/\bou elle\b/g, 'où elle'],
    [/\bmoment ou\b/g, 'moment où'],
    [/\btemps ou\b/g, 'temps où'],
    [/\bpoint ou\b/g, 'point où'],
    [/\bespace ou\b/g, 'espace où'],
    [/\bmode ou\b/g, 'mode où'],
    [/\bechelle ou\b/g, 'échelle où'],
    [/\bsituation ou\b/g, 'situation où'],
    [/\bcas ou\b/g, 'cas où'],
    [/\bregime ou\b/g, 'régime où'],
    [/\bOu F_/g, 'Où F_'],
    [/\bOu sigma\b/g, 'Où sigma'],
    [/\bOu A est\b/g, 'Où A est'],
    [/\bOu P est\b/g, 'Où P est'],
    [/\bOu E est\b/g, 'Où E est'],
    [/\bOu N est\b/g, 'Où N est'],
    [/\bOu T est\b/g, 'Où T est'],
    [/\bOu R est\b/g, 'Où R est'],
    [/\bOu I est\b/g, 'Où I est'],
    [/\bOu V est\b/g, 'Où V est'],
    [/\bOu M est\b/g, 'Où M est'],
    [/\bOu omega\b/g, 'Où omega'],
    [/\bOu rho\b/g, 'Où rho'],
    [/\bOu tau\b/g, 'Où tau'],
    [/\bOu k\b/g, 'Où k'],
    [/\bOu n\b/g, 'Où n'],
